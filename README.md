...
- 🤖 **自动注册**: 全自动化账户注册流程，支持智能人机验证处理
- 🎭 **浏览器自动化**: 通过Puppeteer实现完整的浏览器登录自动化
- 📈 **使用详情**: 详细的使用统计和剩余额度
- 🌍 **多语言**: 支持中英文界面切换
- 🚪 **安全退出**: 一键清空所有认证数据
...
### 🔐 认证相关
- **🤖 自动注册账户** (`Augment Tracker: 🤖 Auto Register Account`) - 全自动化注册新账户
- **🎭 浏览器登录并提取Cookie** (`Augment Tracker: 🎭 Puppeteer Login & Extract Cookies`) - 通过浏览器自动化登录并提取Cookie
...
### v1.0.5（当前版本）
- 🤖 **自动注册功能**: 新增全自动化账户注册流程
- 🧠 **智能人机验证**: 支持三种人机验证处理模式（智能等待/手动交互/手动验证）
- 🌐 **浏览器自动化**: 集成Puppeteer实现完整的浏览器操作自动化
- 📧 **邮箱配置**: 支持手动输入邮箱，后期将支持自动生成
- 🔐 **验证码处理**: 智能验证码输入和验证流程
- 🍪 **Cookie自动提取**: 注册完成后自动提取并配置认证信息
- 📖 **详细文档**: 提供完整的使用指南和故障排除文档
